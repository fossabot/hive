...
type Bee struct {
	...
	Deps         []string   `protobuf:"bytes,16,rep,name=Deps,proto3" json:"Deps,omitempty"`
	Cons         []string   `protobuf:"bytes,17,rep,name=Cons,proto3" json:"Cons,omitempty"`
...
type Hive struct {
	...
	Author       string         `protobuf:"bytes,5,opt,name=Author,proto3" json:"Author,omitempty" bson:"author,omitempty" json:"author" yaml:"author"`
	Public       bool           `protobuf:"varint,8,opt,name=Public,proto3" json:"Public,omitempty" bson:"public,omitempty" json:"public" yaml:"public"`
	Deps         map[string]Dep `protobuf:"bytes,9,rep,name=Deps,proto3" json:"Deps" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (*PushHive) Descriptor() ([]byte, []int) {
	return fileDescriptor_d635d1ead41ba02c, []int{20}
}
...
func (*PushBeeRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_d635d1ead41ba02c, []int{21}
}
...
func (*PushHiveRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_d635d1ead41ba02c, []int{22}
}
...
func init() {
	...
	proto.RegisterType((*Version)(nil), "hive.Version")
	proto.RegisterType((*Bee)(nil), "hive.Bee")
	proto.RegisterType((*Bees)(nil), "hive.Bees")
	proto.RegisterType((*BeeReq)(nil), "hive.BeeReq")
	proto.RegisterType((*BeesReq)(nil), "hive.BeesReq")
...
var fileDescriptor_d635d1ead41ba02c = []byte{
	...
	,
}
...
func (m *Version) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Mod != 0 {
		i = encodeVarintHive(dAtA, i, uint64(m.Mod))
		i--
		dAtA[i] = 0x18
	}
	if m.Minor != 0 {
		i = encodeVarintHive(dAtA, i, uint64(m.Minor))
		i--
		dAtA[i] = 0x10
	}
	if m.Major != 0 {
		i = encodeVarintHive(dAtA, i, uint64(m.Major))
		i--
		dAtA[i] = 0x8
	}
...
func (m *Bee) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Cons) > 0 {
		for iNdEx := len(m.Cons) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintHive(dAtA, i, uint64(len(m.Cons[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x8a
	...
	if len(m.Deps) > 0 {
		for iNdEx := len(m.Deps) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintHive(dAtA, i, uint64(len(m.Deps[iNdEx])))
			i--
			dAtA[i] = 0x1
			i--
			dAtA[i] = 0x82
	...
	if len(m.Tag) > 0 {
		i -= len(m.Tag)
		copy(dAtA[i:], m.Tag)
		i = encodeVarintHive(dAtA, i, uint64(len(m.Tag)))
		i--
		dAtA[i] = 0x62
	}
	if len(m.Keywords) > 0 {
...
func (m *Bees) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.StatusMessage) > 0 {
		...
		i = encodeVarintHive(dAtA, i, uint64(len(m.StatusMessage)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Bees) > 0 {
...
func (m *BeesReq) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BeeNames) > 0 {
		for iNdEx := len(m.BeeNames) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintHive(dAtA, i, uint64(len(m.BeeNames[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *Version) Size() (n int) {
	...
	_ = l
	if m.Major != 0 {
		n += 1 + sovHive(uint64(m.Major))
	}
	if m.Minor != 0 {
		n += 1 + sovHive(uint64(m.Minor))
	}
	if m.Mod != 0 {
		n += 1 + sovHive(uint64(m.Mod))
	}
	return n
}
...
func (m *Hive) Size() (n int) {
	...
	if len(m.Deps) > 0 {
		for k, v := range m.Deps {
			...
			_ = v
			l = v.Size()
			mapEntrySize := 1 + len(k) + sovHive(uint64(len(k))) + 1 + l + sovHive(uint64(l))
