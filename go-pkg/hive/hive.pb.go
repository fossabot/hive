...
func (*Java) Descriptor() ([]byte, []int) {
	return fileDescriptor_d884906a6a139060, []int{12}
}
...
func (*CPP) Descriptor() ([]byte, []int) {
	return fileDescriptor_d884906a6a139060, []int{13}
}
...
func (*CSharp) Descriptor() ([]byte, []int) {
	return fileDescriptor_d884906a6a139060, []int{14}
}
...
func (*ObjectiveC) Descriptor() ([]byte, []int) {
	return fileDescriptor_d884906a6a139060, []int{15}
}
...
func (*Ruby) Descriptor() ([]byte, []int) {
	return fileDescriptor_d884906a6a139060, []int{16}
}
...
func (*Dart) Descriptor() ([]byte, []int) {
	return fileDescriptor_d884906a6a139060, []int{17}
}
...
func (*PHP) Descriptor() ([]byte, []int) {
	return fileDescriptor_d884906a6a139060, []int{18}
}
...
func (*PushBee) Descriptor() ([]byte, []int) {
	return fileDescriptor_d884906a6a139060, []int{19}
}
...
func (*PushHive) Descriptor() ([]byte, []int) {
	return fileDescriptor_d884906a6a139060, []int{20}
}
...
func (*PushBeeRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_d884906a6a139060, []int{21}
}
...
func (*PushHiveRes) Descriptor() ([]byte, []int) {
	return fileDescriptor_d884906a6a139060, []int{22}
}
...
func init() {
	...
	proto.RegisterType((*ProtoSetup)(nil), "hive.ProtoSetup")
...
var fileDescriptor_d884906a6a139060 = []byte{
	...
	,
}
...
func (m *LanguageSetup) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ProtocBinary) > 0 {
		...
		i = encodeVarintHive(dAtA, i, uint64(len(m.ProtocBinary)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Active {
