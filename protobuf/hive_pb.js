...
goog.exportSymbol('proto.hive.ProtoSetup', null, global);
 ...
 * @constructor
 */
proto.hive.ProtoSetup = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.hive.ProtoSetup.repeatedFields_, null);
};
goog.inherits(proto.hive.ProtoSetup, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.hive.ProtoSetup.displayName = 'proto.hive.ProtoSetup';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.hive.Bee.repeatedFields_ = [17,18];
...
proto.hive.Bee.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    protosetup: (f = msg.getProtosetup()) && proto.hive.ProtoSetup.toObject(includeInstance, f),
    isgateway: jspb.Message.getBooleanFieldWithDefault(msg, 16, false),
    depsList: (f = jspb.Message.getRepeatedField(msg, 17)) == null ? undefined : f,
    consList: (f = jspb.Message.getRepeatedField(msg, 18)) == null ? undefined : f
  };
...
proto.hive.Bee.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 14:
      ...
      break;
    case 15:
      var value = new proto.hive.ProtoSetup;
      reader.readMessage(value,proto.hive.ProtoSetup.deserializeBinaryFromReader);
      msg.setProtosetup(value);
      break;
    case 16:
      var value = /** @type {boolean} */ (reader.readBool());
...
proto.hive.Bee.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getProtosetup();
  if (f != null) {
    writer.writeMessage(
      15,
      f,
      proto.hive.ProtoSetup.serializeBinaryToWriter
    );
  }
...
/**
 * optional ProtoSetup ProtoSetup = 15;
 * @return {?proto.hive.ProtoSetup}
 */
proto.hive.Bee.prototype.getProtosetup = function() {
  return /** @type{?proto.hive.ProtoSetup} */ (
    jspb.Message.getWrapperField(this, proto.hive.ProtoSetup, 15));
};


/**
 * @param {?proto.hive.ProtoSetup|undefined} value
 * @return {!proto.hive.Bee} returns this
*/
proto.hive.Bee.prototype.setProtosetup = function(value) {
 ...
 * @return {!proto.hive.Bee} returns this
 */
proto.hive.Bee.prototype.clearProtosetup = function() {
  return this.setProtosetup(undefined);
};
 ...
 * @return {boolean}
 */
proto.hive.Bee.prototype.hasProtosetup = function() {
  return jspb.Message.getField(this, 15) != null;
};


/**
 * optional bool IsGateway = 16;
 * @return {boolean}
 */
...
proto.hive.Dep.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pkgnamecamel: jspb.Message.getFieldWithDefault(msg, 5, "")
  };
 ...
 * @return {string}
 */
proto.hive.Dep.prototype.getPkgname = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.hive.Dep} returns this
 */
proto.hive.Dep.prototype.setPkgname = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};


/**
 * optional string PkgNameCamel = 5;
 * @return {string}
 */
proto.hive.Dep.prototype.getPkgnamecamel = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};
 ...
 * @return {!proto.hive.Dep} returns this
 */
proto.hive.Dep.prototype.setPkgnamecamel = function(value) {
  return jspb.Message.setProto3StringField(this, 5, value);
};
 ...
 * @const
 */
proto.hive.ProtoSetup.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.hive.ProtoSetup.prototype.toObject = function(opt_includeInstance) {
  return proto.hive.ProtoSetup.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.hive.ProtoSetup} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.hive.ProtoSetup.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.hive.ProtoSetup}
 */
proto.hive.ProtoSetup.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.hive.ProtoSetup;
  return proto.hive.ProtoSetup.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.hive.ProtoSetup} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.hive.ProtoSetup}
 */
proto.hive.ProtoSetup.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.hive.ProtoSetup.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.hive.ProtoSetup.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.hive.ProtoSetup} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.hive.ProtoSetup.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.hive.ProtoSetup.prototype.getFilesList = function() {
...
/**
 * @param {!Array<string>} value
 * @return {!proto.hive.ProtoSetup} returns this
 */
proto.hive.ProtoSetup.prototype.setFilesList = function(value) {
 ...
 * @return {!proto.hive.ProtoSetup} returns this
 */
proto.hive.ProtoSetup.prototype.addFiles = function(value, opt_index) {
 ...
 * @return {!proto.hive.ProtoSetup} returns this
 */
proto.hive.ProtoSetup.prototype.clearFilesList = function() {
...
proto.hive.LanguageSetup.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    protocbinary: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
...
/**
 * optional string ProtocBinary = 3;
 * @return {string}
 */
proto.hive.LanguageSetup.prototype.getProtocbinary = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.hive.LanguageSetup} returns this
 */
proto.hive.LanguageSetup.prototype.setProtocbinary = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
